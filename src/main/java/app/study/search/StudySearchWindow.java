...
public class StudySearchWindow {
    ...
    private static AnchorPane buildAnchorPane() {
        ...
        rootFxml.setLocation(StudySearchWindow.class.getResource("StudySearchWindow.fxml"));
        rootFxml.setController(new StudySearchControl());
    ...
    private static void buildStage(Stage stageOwner) {
        ...
        stage.setTitle("Busca de Estudo");
    }
}
