...
public class StudyDao implements Dao<Study> {
    ...
    public void updateFullInStudy(Study study) throws Exception {
        Connection connection = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            saveOrUpdateOrRemoveTopics(study, pstmt, connection, result);
            updateNotes(study, pstmt, connection);
            connection.commit();
        } catch (SQLException e) {
            e.printStackTrace();
            connection.rollback();
    ...
    public void saveOrUpdateOrRemoveTopics(Study study, PreparedStatement pstmt, Connection connection,
        ...
        String query5 = "DELETE FROM topic "
                      + "WHERE topic_id = ?; ";
    ...
    public void updateNotes(Study study, PreparedStatement pstmt, Connection connection)
            throws SQLException {
        ...
        pstmt = connection.prepareStatement(sql);
        pstmt.setString(1, study.getNotes());
        pstmt.setLong(2, study.getId());
        pstmt.executeUpdate();
    }

    public Study consult(Long idStudy) throws SQLException {
        Connection connection = null;
        PreparedStatement pstmt = null;
        ResultSet result = null;
        Study study = null;
        ...
        try {
            ...
            if (result.next()) {
                ...
                study.setNotes(result.getString("study_notes"));
    ...
    private List<Topic> consultListTopic(Long idStudy) throws SQLException {
        Connection connection = null;
        ResultSet result = null;
        PreparedStatement pstmt = null;
